...
<style>
html,body,form,table,tr,td,div,p,span{
	margin:0px;
	padding:0px;
}
...
.filestyle{ background-color:#FFF;}
</style>
...
<div class="third">
<div class="forth">	
<div class="head">软件升级</div><div class="hr"></div>
<div id="main">
<table  class="content1"  width=100% id="MyTable" cellspacing="0">
	<tr><td width="100" align="left" id="file">文件</td><td>
